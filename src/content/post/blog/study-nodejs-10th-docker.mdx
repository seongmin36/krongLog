...
date: "2026-06-07"
tags: ["NestJS", "Docker", "PostgreSQL", "DevOps"]
...
{/* <!-- ![Docker 설치 완료](/images/study-nodejs-10th-docker/1.png) --> */}
...
{/* <!-- ![PostgreSQL 컨테이너 기동 확인](/images/study-nodejs-10th-docker/2.png) --> */}
...
{/* <!-- ![Nest 기동 성공 로그](/images/study-nodejs-10th-docker/3.png) --> */}

브라우저에서 `http://[탄력적-IP]:8080/api`로 접속해 응답을 확인합니다.

{/* <!-- ![API 응답 확인](/images/study-nodejs-10th-docker/4.png) --> */}
